...
### Core Structure
- **Main Plugin Class**: `src/JpmMartinSyliusSubscriptionPlugin.php` - Entry point using `SyliusPluginTrait`
- **DI Extension**: `src/DependencyInjection/JpmMartinSyliusSubscriptionExtension.php` - Handles service loading and Doctrine migrations
