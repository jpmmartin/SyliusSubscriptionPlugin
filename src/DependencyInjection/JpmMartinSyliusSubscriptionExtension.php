...
final class JpmMartinSyliusSubscriptionExtension extends AbstractResourceExtension implements PrependExtensionInterface
{
    ...
    {
        /** @var array{driver: string, resources: array<string, mixed>, payment_methods: list<string>, retry_delays: list<int>, final_decline_codes: list<string>, suspend_after_failed_cycles: int|null, missed_cycles: string, renewal_notice_days: int|null, consent_version: string} $config */
