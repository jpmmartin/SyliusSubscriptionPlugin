...
/**
 * What the product page offers. Adding to the cart is a live-component action the browserless
 * driver cannot run, so it is covered by tests/Functional/Shop instead.
 */
final class SubscribingToProductsContext implements Context
{
    private const LOCALE = 'en_US';

    public function __construct(private readonly SubscriptionPlanChoicePage $productPage)
    {
    }
